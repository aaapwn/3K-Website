        ...
        <WarpBackground className="bg-secondy/5" beamSize={2} beamDuration={4} gridColor="#7B818930">
            <div className=" px-12 flex flex-row justify-between items-center">
                <div className="w-[679px] flex flex-col gap-5">
                    ...
                    <h1 className="font-bold text-7xl leading-[64px]">กีฬาประเพณี<br /><strong className="text-firsto">3พระจอม ครั้งที่ 16</strong></h1>
                ...
                <div>
                    <div>
                        <img src="/images/heroimage.png" alt="logo" className="rounded-xl" width={879} />
                    </div>
                </div>
            </div>
        </WarpBackground>
