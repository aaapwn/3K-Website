  ...
  return (
    <footer className="flex md:flex-row flex-col md:justify-between justify-center md:text-start text-center py-6 px-5 bg-secondb text-secondw md:text-xl text-medium">
      <div className="px-2.5 justify-between">
        ...
        <div className="flex flex-row justify-center md:justify-start align-middle items-center">
          <Image src={sor} alt="logo" className="object-contain w-16" />
          <Image src={logo} alt="logo" className="object-contain w-16" />
        </div>
        <div className="flex-col md:px-2.5 justify-between flex md:hidden gap-5">
          <div className="flex-col flex gap-5">
            <p className="font-medium text-2xl text-center py-5 px-5 border-b-1 border-secondy w-fit self-center">
              ช่องทางการติดต่่อ
            </p>
        ...
        <Link
          ...
          target="_blank"
          href={'https://www.placeholderpayments.com/legal/terms-of-service.html'}
          className="underline"
        >
