...
const Footer = () => {
    return (
        <footer className="flex flex-row justify-between py-6 px-32 bg-secondb text-secondw text-xl drop-shadow-md">
            ...
            <div className="flex flex-col px-2.5 justify-between">
                <div className=''>
